/*
 * application library of ch342/ch343/ch344/ch9101/ch9102/ch9103/ch9104, etc.
 *
 ...
 * V1.3 - added support of control transfer and eeprom operation API
 */
...
typedef struct _ch343cfg {
    ...
    uint8_t bReserved[4];
    uint8_t bSerialNumber[24];
    uint8_t bStringDescriptor[40];
    uint8_t bManufacturerDescriptor[40];
} ch343cfg, *pch343cfg;

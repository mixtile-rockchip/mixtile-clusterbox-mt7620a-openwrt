...
define Kernel/CompileImage/Initramfs
	...
	echo "DISTRIB_RELEASE=\"\"" >> $(TARGET_DIR)/etc/os-release
	echo "VERSION=\"\"" >> $(TARGET_DIR)/etc/os-release
	echo "BUILD_ID=\"MIXTILE\"" >> $(TARGET_DIR)/etc/os-release
	sed -i '/DISTRIB_REVISION/d' $(TARGET_DIR)/etc/openwrt_release
	sed -i '/DISTRIB_DESCRIPTION/d' $(TARGET_DIR)/etc/openwrt_release
	echo "DISTRIB_REVISION=\"\"" >> $(TARGET_DIR)/etc/openwrt_release
	...
	echo "" > $(TARGET_DIR)/etc/openwrt_version
